...
export default function Home() {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-center underline-offset-0 text-[28px]">Privacy Policy</h1>
      <br />
      <p style={{ fontStyle: 'italic', fontFamily:"sans-serif", color:"black"}}> This policy is effective as of January 10, 2025</p>
      <br />
      <p>
        Bambooo21 Studio as studio built by from Bamboo Indonesia providing a unique or innovative solution, use case, and experience in built the an usefull apps and games. This SERVICE is provided by Bamboo Indonesia at no cost and is intended for use as is.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
      The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Bamboo Indonesia unless otherwise defined in this Privacy Policy.   </p>
      <br />
